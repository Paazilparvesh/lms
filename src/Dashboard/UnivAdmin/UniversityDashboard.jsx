...
function UnivAdminDashboard() {
  ...
  const sidebarItems = [
    ...
    { id: "icon5", icon: <MdSettings size={22} />, label: "Settings" },
  ];
  ...
  return (
    ...
    >
      ...
      {/* Sidebar */}
      <div
        className={`transition-all duration-300 h-[calc(100vh-50px)] shadow-lg overflow-y-auto fixed top-12 left-0 z-40 ${
        ...
        <div className="flex flex-col items-start h-full p-3">
          ...
          {sidebarItems.map((item) => (
            <div
              ...
              className={`flex items-center gap-3 p-2 my-1 rounded-md cursor-pointer w-full transition-all duration-200 hover:bg-blue-100 dark:hover:bg-slate-700 ${
                activeIcon === item.id
