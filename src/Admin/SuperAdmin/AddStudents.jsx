...
function AddStudent() {
  ...
  const fetchStudents = () => {
    axios
      .get(`https://lmsdemo.thirdvizion.com/api/studentdetails/`)
      .then((res) => {
        setStudent(res.data);
      })
  ...
  const fetchUniversities = () => {
    axios
      .get(`https://lmsdemo.thirdvizion.com/api/university/`)
      .then((res) => {
  ...
  const submitBulkUsers = async () => {
    ...
    try {
      await axios.post("https://lmsdemo.thirdvizion.com/api/bulkupload/", {
        users: bulkUsers,
      });
      openModal(
  ...
  const singleUpload = async () => {
    ...
    try {
      await axios.post("https://lmsdemo.thirdvizion.com/api/register/", {
        name,
        email,
        user_type,
  ...
  const handleSelectedDelete = async () => {
    ...
    console.log(
      ...
      JSON.stringify(
        {
          select_all: false,
          selected_name: selectedStudentEmails, // this is now email list
        },
        null,
        2
      )
    ...
    try {
      const response = await axios.delete(
        "https://lmsdemo.thirdvizion.com/api/studentdelete/",
        {
          data: {
            select_all: false,
            selected_name: selectedStudentEmails, // directly using email
          },
        }
      );
