...
//   const [profilePhoto, setProfilePhoto] = useState(""); // stores Cloudinary URL
...
//     try {
//       await axios.put(`${import.meta.env.VITE_UPDATE_PROFILE}${userEmail}`, payload);
...
//               loading ? "bg-gray-400 cursor-not-allowed" : "bg-[#FF6A00] hover:bg-orange-600"
//             }`}
//           >
...
function EditProfile() {
  ...
  return (
    <div
      className={`min-h-screen flex justify-center items-center px-4 py-10 font-mono transition-colors duration-300 ${
        isDarkMode ? "bg-[#111827] text-white" : "bg-orange-50 text-gray-800"
      }`}
    >
      <div
        className={`w-full max-w-md rounded-xl shadow-xl p-8 border ${
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              value={name}
              onChange={(e) => setName(e.target.value)}
              className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 transition-all ${
