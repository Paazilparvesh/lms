...
function Header() {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 flex items-center justify-between h-[45px] md:h-[55px] lg:h-[60px] transition-all duration-300 font-mono bg-white dark:bg-black text-black dark:text-white shadow-md">
      {/* <img
        src={Logo}
        alt="Scopik Logo"
